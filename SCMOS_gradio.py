...
with gr.Blocks() as demo:
    ...
    with gr.Column() as col2:
        ...
        gr.Markdown("## Input which of Left and Right audio sound the closest to the reference:\n\n"
                    "- 2  <=> Right sounds closer to reference\n"
                    "- 1  <=> Right sounds slightly closer to reference\n"
                    "- 0  <=> Both are equal\n"
                    "- -1 <=> left sounds slightly closer to reference\n"
                    "- -2 <=> Left sounds closer to reference\n\n\n"
